...
export class DeliveryDetails {
    ...
    saveDetails = async () => {
        // here we are asserting that after clicking 'Save address for next time' button, the address is saved and appears in the saved address container
        ...
        // here we are asserting that inputted information is correctly displayed in the saved address container
